...
(function (root, factory) {
  ...
  function _bindTooltips(resetTooltips) {
    ...
    Array.prototype.forEach.call(
      ...
      function (elm, idx) {
        var tooltipText = elm.getAttribute("data-title").trim();
        var options;
        ...
        if (
          ...
          if (tooltipText.length === 0) {
            elm.setAttribute("data-title", _tooltipsTemp[idx].text);
    ...
    if (tooltipElm) {
      tooltipTop =
        ...
        window.innerHeight
          ...
          : tooltipTop;
      tooltipLeft =
        tooltipLeft - scrollX + tooltipElm.offsetWidth + 20 >= window.innerWidth
