  ...
  return (
    <div className="FAQ">
      ...
      <p className="p_FAQ">
        ...
        right click on the <i>Map preview</i> and choose <i>Save image as...</i>. Next time you can upload the image you saved.
      </p>
      ...
      <p className="p_FAQ">
        ...
        and export as .schematic. <i>Note that if you're using MCEdit or Cubical, you must export the map as 1.12.2.</i> You do not need a .schematic file for
      ...
      <p className="p_FAQ">Change your map size, enable the crop option, or edit your image with an image editor.</p>
