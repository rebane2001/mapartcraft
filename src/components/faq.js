  ...
  return (
    <div className="FAQ">
      <Link to={`/${![undefined, "en"].includes(props.match.params.countryCode)? props.match.params.countryCode : "" }`}>
        <h3 className="closeTextButton">Close</h3>
      </Link>
      ...
      <p className="p_FAQ">
        ...
        ). It might be a better idea to use a datafile instead - it's easier and
        gives more colors.
      </p>
      ...
      <p className="p_FAQ">
        ...
        You do not need a .schematic file for use with Baritone; use Schematica
        and the "#schematica" command.
      </p>
      ...
      <p className="p_FAQ">
        ...
        of it; if the Northern block is higher then a darker tone shows, else if
        the Northern block is lower then a lighter tone shows, else a normal
        tone shows. Thus an extra row of blocks (colloquially known as a
        noobline) exists at the top of a map to shade the top row properly.
      </p>
      ...
      <p className="p_FAQ">
        ...
        for aligning your schematic. Maps in Minecraft align to a fixed 128x128
        grid. North is always the up-direction on maps and you shouldn't rotate
        the schematic.
      </p>
      ...
      <p className="p_FAQ">
        You can use the map.dat file in singleplayer or a server you own. Create
        a new map in-game, go to your world's save file, then the data folder
        and from there you can replace map_xxx.dat files.
      </p>
      ...
      <p className="p_FAQ">
        Change your map size, enable the crop option, or edit your image with an
        image editor.
      </p>
      ...
      <b>Better color?</b>
      <p className="p_FAQ">
        This setting will give you more natural colors. Disabling this will make
        the website faster and give you slightly worse colors. It is recommended
      ...
      <p className="p_FAQ">
        ...
        dithering will usually have less artifacts and gives the image an unique
        style. It is usually recommended to disable dithering for flat-colored
        artwork.
      </p>
      ...
      <p className="p_FAQ">
        ...
        blocks and click "Save" to save them as a preset, pick a preset to load
        it and click "Delete" to delete the loaded preset. It is also possible
        to share a link for your preset with others.
      </p>
    </div>
  );
}
